...
var _TodoCreater = __webpack_require__(30);
...
var TodoApp = function (_React$Component) {
  ...
  _createClass(TodoApp, [{
    ...
    value: function callBackRemoveTask(id) {
      var data = _.reject(this.state.data, { 'id': id });
      this.setState({
        data: data
      });
    }
...
var _Task = __webpack_require__(28);
...
var Task = function (_React$Component) {
  ...
  function Task(props) {
    ...
    _this.handleKeyUpCloseEdit = _this.handleKeyUpCloseEdit.bind(_this);
  ...
  _createClass(Task, [{
    ...
    key: 'componentWillUnmountWillMount',
    value: function componentWillUnmountWillMount() {
    ...
    value: function render() {
      ...
      var input = this.state.editMode ? _react2.default.createElement('input', { type: 'text', className: 'editText', value: this.state.text,
        onChange: this.handleChangeText, onKeyUp: this.handleKeyUpCloseEdit }) : _react2.default.createElement(
        'span',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'inputArea' },
          _react2.default.createElement('input', { type: 'text', className: 'inputText', value: this.state.val,
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', className: 'searchBox__input', onChange: this.handleChange,
